...
public class minut90Parser extends Parser {
	...
	public static final int
		...
		T__9=10, OKR_L=11, OKR_R=12, KLA_L=13, KLA_R=14, CU=15, STRING=16, WS=17, 
		INT=18, DIGIT=19;
	public static final int
		RULE_r = 0, RULE_liga = 1, RULE_druzyny = 2, RULE_druzyna = 3, RULE_mecze = 4, 
		RULE_punkty = 5, RULE_zwyciestwa = 6, RULE_remisy = 7, RULE_porazki = 8, 
		RULE_bramki = 9, RULE_strzelone = 10, RULE_stracone = 11;
	public static final String[] ruleNames = {
		"r", "liga", "druzyny", "druzyna", "mecze", "punkty", "zwyciestwa", "remisy", 
		"porazki", "bramki", "strzelone", "stracone"
	};

	private static final String[] _LITERAL_NAMES = {
		null, "'liga'", "'druzyna'", "'mecze'", "'punkty'", "'zwyciestwa'", "'remisy'", 
		"'porazki'", "'bramki'", "'strzelone'", "'stracone'", "'('", "')'", "'{'", 
		"'}'", "'\"'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, null, null, null, null, null, null, null, null, null, null, "OKR_L", 
		"OKR_R", "KLA_L", "KLA_R", "CU", "STRING", "WS", "INT", "DIGIT"
	};
	...
	public static class MeczeContext extends ParserRuleContext {
		public TerminalNode OKR_L() { return getToken(minut90Parser.OKR_L, 0); }
		public TerminalNode INT() { return getToken(minut90Parser.INT, 0); }
		public TerminalNode OKR_R() { return getToken(minut90Parser.OKR_R, 0); }
		public MeczeContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_mecze; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).enterMecze(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).exitMecze(this);
		}
	}
	...
	public static class PunktyContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_punkty; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).enterPunkty(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).exitPunkty(this);
		}
	}
	...
	public static class ZwyciestwaContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_zwyciestwa; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).enterZwyciestwa(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).exitZwyciestwa(this);
		}
	}
	...
	public static class RemisyContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_remisy; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).enterRemisy(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).exitRemisy(this);
		}
	}
	...
	public static class PorazkiContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_porazki; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).enterPorazki(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).exitPorazki(this);
		}
	}
	...
	public static class StrzeloneContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_strzelone; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).enterStrzelone(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).exitStrzelone(this);
		}
	}
	...
	public static class StraconeContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_stracone; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).enterStracone(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof minut90Listener ) ((minut90Listener)listener).exitStracone(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"[\7\24\2\2[\\\7\16\2\2\\\27\3\2\2\2]^\7\f\2\2^_\7\r\2\2_`\7\24\2\2`a\7"+
		"\16\2\2a\31\3\2\2\2\3(";
